<?php
class Mage_PayTpvCom_Block_Standard_Bankstoretest extends Mage_Core_Block_Template
{
    protected function _construct()
    {
        ...
        $this->assign( "URL_OK",Mage::getUrl('paytpvcom/standard/reciboBankstore'));
        ...
        $this->assign( "DSECURE",($standard->isSecureTransaction())?1:0);
