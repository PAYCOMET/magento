...
class Mage_PayTpvCom_Model_Api extends Varien_Object
{
    ...
    */
                        ...
                        case 'blink':
                            ...
                            for ( $j = 0; $j < $j_count; $j++ ) {
                                if ( strstr( $browser_user_agent, $a_blink_types[$j] ) ) {
                                    ...
                                    $blink_type_number = $this->get_item_version( $browser_user_agent, $blink_type );
    ...
    public function get_item_math_number( $pv_browser_number )
    {
        $browser_math_number = '';
    ...
    **/
    ...
    public function get_html_level( $pv_render_engine, $pv_render_engine_nu )
    {   
        $html_return = 1;
