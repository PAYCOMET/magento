...
if (version_compare(Mage::getVersion(), '1.6', '>=')) {
    ...
    if ($installer->getConnection()->isTableExists($installer->getTable('paytpvcom/customer')) != true) {
        ...
        ->addColumn('date', Varien_Db_Ddl_Table::TYPE_TIMESTAMP, null, array(
            'nullable'  => true), 
        'Date')
        ->addIndex($installer->getIdxName('paytpvcom/customer', array('customer_id'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE),
            array('customer_id'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE))
